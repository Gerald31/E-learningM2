...
const tutoratsAvailables = computed(() => tutoratStore.tutoratsAvailableTutor);
                    ...
                    <div class="overflow-hidden border rounded-lg">
                        <table class="w-full divide-y divide-gray-200 table-fixed">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr v-for="tutoratsAvailable in tutoratsAvailables">
                                <td
                                    class="px-2 py-4 text-sm text-gray-800 text-center"
                                >
                                    {{ $filters.datefr(tutoratsAvailable.date) }} <br/>à <br/>{{ $filters.timefr(tutoratsAvailable.time_start) }} - {{ $filters.timefr(tutoratsAvailable.time_end) }}
                                </td>
                                <td class="py-3 pl-4">
                                ...
                                >
                                    {{ tutoratsAvailable.description }}
                                </td>
                                <td
                                    class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap"
                                >
                                    {{ tutoratsAvailable.price }} €
                                </td>
                            </tr>
                            </tbody>
                        </table>
