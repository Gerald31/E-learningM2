...
const tutoratsAffecteds = computed(() => tutoratStore.tutoratsAffectedStudent(currentUser.value?.id));
                    ...
                    <div class="overflow-hidden border rounded-lg">
                        <table class="w-full divide-y divide-gray-200 table-fixed">
                            ...
                            <tr v-for="tutoratsAffected in tutoratsAffecteds" @click="pushToChat(tutoratsAffected)" class="cursor-pointer">
                                ...
                                <td class="py-3 pl-4 text-sm text-gray-800">
                                    {{ tutoratsAffected.tutor.lastname }} {{ tutoratsAffected.tutor.firstname }}
                                </td>
                                <td class="py-3 pl-4">
                                ...
                                >
                                    {{ $filters.totalAmount(tutoratsAffected.price) }} €
                                </td>
                            </tr>
                            </tbody>
                        </table>
