    ...
    <div class="w-full p-5 flex">
        ...
        <div>
            <div
                ...
                <InboxIcon class="w-5 h-5 text-gray-500 dark:text-white dark:opacity-70 " />
            </div>
        </div>

        <!--content-->
        <div>
            <Typography variant="heading-2" class="mb-3">No archived conversations</Typography>

            <Typography variant="body-2" class="flex">
                select archive from the conversation context menu
                to save one.
            </Typography>
        </div>
    </div>
