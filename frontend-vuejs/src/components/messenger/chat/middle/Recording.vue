...
import RangeSlider from "@/components/messenger/reusables/RangeSlider.vue";
import Typography from '@/components/messenger/reusables/Typography.vue';

const props = defineProps({ recording: Object, self: Boolean });
...
<template>
    <div class="flex items-center outline-none" tabindex="0" aria-label="audio message">
        ...
        <Typography variant="body-1" noColor :class="props.self ? ['text-white'] : ['text-black', 'opacity-60']"
            tabindex="0" aria-label="11 seconds">
            00:11
        </Typography>
    </div>
</template>
