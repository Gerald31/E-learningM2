...
<template>
        ...
        <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
            <li>
                <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                    <img class="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0" :src="avatar" alt="Jese Leos image"/>
            ...
            <li>
                <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                    <img class="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0" :src="avatar" alt="Bonnie Green image"/>
                    <div>
    ...
    <div class="p-5 border border-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        ...
        <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
            <li>
                <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                    <img class="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0" :src="avatar" alt="Laura Romeros image"/>
                    <div class="text-gray-600 dark:text-gray-400">
            ...
            <li>
                <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                    <img class="w-12 h-12 mb-3 mr-3 rounded-full sm:mb-0" :src="avatar" alt="Mike Willi image"/>
                    <div>
